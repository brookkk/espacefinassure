      <div class="navbar navbar-fixed-top scroll-hide">
          ...
          <div class="pull-right">
            <ul class="nav navbar-nav pull-right">
			  ...
			  <li class="dropdown user hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <!--<img width="34" height="34" src="images/avatar50.png" />-->Bienvenue <?php echo $_SESSION['pseudo']?><b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <!--<li><a href="#">
        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              <li>
                <a class="current" href="index.php"><span aria-hidden="true" class="se7en-home"></span>Accueil</a>
              </li>
              <li><a class="current" href="social.php">
                <span aria-hidden="true" class="se7en-feed"></span>Procédure RC Sport</a>
              </li>
              <li><a class="current" href="download.php">
                <span aria-hidden="true" class="se7en-star"></span>Téléchargement</a>
                <!--<ul class="dropdown-menu">
              ...
              <li class="dropdown"><a class="current" href="adherents.php">
                <span aria-hidden="true" class="se7en-tables"></span>Adhérents</a>
                <!--<ul class="dropdown-menu">
                  <li>
              ...
              <li><a class="current" href="charts.html">
                <span aria-hidden="true" class="se7en-charts"></span>Tableau de bord</a>
              </li>
              <!--<li class="dropdown"><a data-toggle="dropdown" href="#">
